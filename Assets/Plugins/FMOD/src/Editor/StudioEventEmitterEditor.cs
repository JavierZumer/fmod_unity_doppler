...
namespace FMODUnity
{
    ...
    public class StudioEventEmitterEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var kinematicVelocity = serializedObject.FindProperty("UseKinematicVelocity");
            ...
            if (editorEvent != null)
            {
                ...
                if (fadeout.isExpanded)
                {
                    ...
                    EditorGUILayout.PropertyField(kinematicVelocity, new GUIContent("Use Kinematic Velocity"));
                }
            }
