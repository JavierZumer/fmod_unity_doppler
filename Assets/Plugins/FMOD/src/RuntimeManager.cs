...
retry:
        ...
        class AttachedInstance
        {
            ...
            #endif
            public VelocityVector3 kinematicVelocity;
...
#if UNITY_PHYSICS_EXIST
                    if (attachedInstances[i].rigidBody && !attachedInstances[i].useKinematicVelocity)
                    {
...
#endif
#if UNITY_PHYSICS2D_EXIST
                    if (attachedInstances[i].rigidBody2D && !attachedInstances[i].useKinematicVelocity)
                    {
...
#endif
                    else if (attachedInstances[i].useKinematicVelocity && attachedInstances[i].kinematicVelocity != null)
                    {
        ...
        public static void AttachInstanceToGameObject(FMOD.Studio.EventInstance instance, Transform transform, VelocityVector3 kinematicVelocity)
        {
            AttachedInstance attachedInstance = Instance.attachedInstances.Find(x => x.instance.handle == instance.handle);
            if (attachedInstance == null)
            {
            ...
            instance.set3DAttributes(RuntimeUtils.To3DAttributes(transform, kinematicVelocity));
            attachedInstance.transform = transform;
            attachedInstance.instance = instance;
        ...
        public static void SetListenerLocation(int listenerIndex, GameObject gameObject, VelocityVector3 kinematicVelocity)
        {
